...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Pasien Rawat Inap</li>
    ...
    <h5 style="color:darkblue; font-weight:bold; margin-top:13px; margin-bottom:40px">Tambah Data Pasien Rawat Inap</h5><br><br><br>

    <form action="Srawat.php" method="POST" style="margin-left:70px; font-size:13px;">

      <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label" style="color:darkblue;">Id Pasien</label>
                  <div class="col-sm-6">
                    <input type="text" name="idrwt" id="idrwt" placeholder="tidak perlu diisi, karena terisi otomatis!!" class="form-control" style="font-size:13px;">
                  </div>
          </div>
      ...
      <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                  <select class="form-control" name="nmrwt" id="nmrwt" style="font-size: 13px;">
