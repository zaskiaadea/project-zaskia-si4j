...
<div class="pagetitle">
      <h1 style="font-weight: bold;">Edit Data Pasien Bersalin &nbsp;
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="?page=riwayat_bersalin">Riwayat Pasien</a></li>
      ...
      <?php
          ...
          $sqldatabersalin="SELECT * FROM tb_bersalin WHERE id='$idbsn'";
          //ambil koneksi data
          require_once "../config/koneksi.php";
          //proses sql
          $query=mysqli_query($koneksi,$sqldatabersalin);
     ...
     <div class="row" id="idbsn<?= $data['id']; ?>" style="background-color:aliceblue; padding: 20px; width: 100%;">
    ...
    <form action="Ubersalin.php" method="POST" style="margin-left:70px; font-size:13px;">

    <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label" style="color:darkslategray;">Id</label>
                  <div class="col-sm-6">
                    <input type="text" name="idbsn" id="idbsn" value="<?=$data['id']?>" placeholder="" class="form-control" style="font-size:13px;">
                  </div>
          </div>
      ...
      <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="nmbsn" id="nmbsn" value="<?=$data['nama_pasien']?>" placeholder="" class="form-control" style="font-size:13px;">
                  </div>
          </div>
      ...
      <div class="row mb-3">
          ...
          <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="kmbsn" id="kmbsn" value="<?=$data['kamar']?>" placeholder="" class="form-control" style="font-size:13px;">
                  </div>
          </div>
